...
private struct ProviderSidebarRowView: View {
    ...
    var body: some View {
        ...
        HStack(alignment: .center, spacing: 10) {
            ProviderSidebarReorderHandle()
                ...
                .help("Drag to reorder".appLocalized)
                .onDrag {
    ...
    private var statusText: String {
        ...
        if lines.count >= 2 {
            ...
            return "\(AppLocalization.ui("Disabled")) — \(first)\n\(rest)"
        }
        return "\(AppLocalization.ui("Disabled")) — \(self.subtitle)"
    }
}
...
private struct ProviderSidebarReorderHandle: View {
    var body: some View {
        ...
        .accessibilityLabel("Reorder".appLocalized)
    }
}
